...
import CourseTutorCard from '../../components/course/CourseTutorCard';
...
function MyCourse(props) {
    ...
    React.useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            if (rightSection.scrollTop + rightSection.clientHeight >= rightSection.scrollHeight) {
    ...
    return (
        <div
            className={`w-screen h-screen relative flex flex-row ${canScrollRoot ? 'overflow-y-scroll' : 'overflow-hidden'
                }`}
        >
            <CourseTutorCard />
            <div

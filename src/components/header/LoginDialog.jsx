        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col gap-y-4">
            ...
            <div className="flex items-center justify-between h-16">
              <Button
                className={`rounded-full normal-case xl:text-lg sm:text-base text-sm px-3 py-1 max-w-80 w-80 transition-all duration-300 ${
                  active
              ...
              <Button
                className="bg-gray-400 rounded-full normal-case xl:text-lg sm:text-base text-sm px-3 py-1 text-black"
                disabled={isSubmit}
              >
                Quên mật khẩu
              </Button>

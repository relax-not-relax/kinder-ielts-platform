    ...
    return (
        <div className='mt-6 px-8'>
            ...
            <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(1)} className='p-4 w-full flex flex-row justify-between items-center bg-custom-green/15'>
            ...
            <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(2)} className='p-4 w-full flex flex-row justify-between items-center bg-custom-green/15'>
                    <h4 className='text-lg font-semibold'>2. Writing short responses to given prompts</h4>
                </AccordionHeader>
                <AccordionBody>
                    <LessonDetails />
                </AccordionBody>
            ...
            <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(3)} className='p-4 w-full flex flex-row justify-between items-center bg-custom-green/15'>
                    <h4 className='text-lg font-semibold'>3. Vocabulary building for writing tasks</h4>
                </AccordionHeader>
                <AccordionBody>
                    <LessonDetails />
                </AccordionBody>
